                    ...
                    >
                        ...
                        <div className="overflow-y-auto h-[calc(100%-5rem)]">
                            {mockDoctors.map(doctor => (
                                <button
                                    key={doctor.id}
                                    className={`w-full p-4 flex items-center hover:bg-gray-50 transition ${selectedDoctor.id === doctor.id ? 'bg-primary-50' : ''
                                        }`}
                                    onClick={() => setSelectedDoctor(doctor)}
                                >
                                    <Avatar user={doctor} size="md" className="mr-3" />
                    ...
                    >
                        <div className="p-4 border-b border-gray-100">
                            <div className="flex items-center">
                                <Avatar user={selectedDoctor} size="md" className="mr-3" />
                                <div>
                        ...
                        <div className="flex-1 overflow-y-auto p-4">
                            {mockMessages.map(msg => (
                                <div
                                    key={msg.id}
                                    className={`flex mb-4 ${msg.senderId === 'p1' ? 'justify-end' : 'justify-start'
                                        }`}
                                >
                                    <div
                                        className={`max-w-[70%] rounded-lg p-3 ${msg.senderId === 'p1'
