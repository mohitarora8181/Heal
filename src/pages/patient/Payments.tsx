...
import { DollarSign, CreditCard, Clock, Receipt, ArrowUpRight, ArrowDownRight } from 'lucide-react';
                ...
                >
                    <Card className="h-full">
                        <CardContent className="p-6">
                            ...
                            <p className="text-2xl font-bold text-gray-800">₹{stats.nextPayment}</p>
                        </CardContent>
                    </Card>
                </motion.div>
                ...
                >
                    <Card className="h-full">
                        <CardContent className="p-6">
                            ...
                            <p className="text-2xl font-bold text-gray-800">{stats.savedCards}</p>
                        </CardContent>
                    </Card>
                </motion.div>
            </div>
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody>
                                        {mockPayments.map(payment => {
                                            const doctor = mockDoctors.find(d => d._id === payment.doctorId);
                                            return (
                                                <tr key={payment.id} className="border-b border-gray-50 hover:bg-gray-50">
                                                    <td className="py-3 px-4">
                                                        <div className="flex items-center">
                                                            {doctor && <Avatar user={doctor} size="sm" className="mr-2" />}
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-2">
                                            <div className="flex items-center">
                                                ...
                                                <span className="font-medium text-gray-800 capitalize">{method.type}</span>
                                            </div>
                                            {method.isDefault && (
