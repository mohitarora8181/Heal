    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (selectedFile) {
                ...
                const fileUploadResponse = await fetch(`${backendUrl}/medical-records/upload`, {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                ...
                fileUrl = fileData.fileName || fileData.fileUrl;
        ...
        <PageLayout>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <motion.div
                        className="bg-white rounded-lg shadow-lg w-full max-w-xl max-h-[90%] overflow-y-scroll"
